...
# ### Early Submission Bonus: 10 points for submission before midnight November 8, 2024
...
Scanners_df = ss.read.csv("/storage/home/tkk5297/work/MiniProj1/Day_2020_profile.csv", schema = scanner_schema, header= True, inferSchema=False)
#Scanners_df = ss.read.csv("/storage/home/tkk5297/work/MiniProj1/sampled_profile.csv", schema = scanner_schema, \
...
sorted_port_count = "/storage/home/tkk5297/work/MiniProj1/sorted_port_count_cluster.txt"
sorted_count_port_RDD.saveAsTextFile(sorted_port_count)


# # Threshold for this MiniProject: 500  in local mode, 30000 in cluster mode
...
# This threshold value is 500 for the local mode.
...
freq_count_port_RDD.saveAsTextFile("/storage/home/tkk5297/work/MiniProj1/freq_1_port_count_cluster.txt")
...
output_path_2_port = "/storage/home/tkk5297/work/MiniProj1/2PS_tkk5297_cluster.csv"
...
#TwoPS_DF = ss.read.csv("/storage/home/juy1/work/MiniProj1/2PS_tkk5297_cluster.csv", header=True, inferSchema=True)
...
# These output file names need to be changed in the cluster mode, so that you can compare them with those from the local mode.
output_path_3_port = "/storage/home/tkk5297/work/MiniProj1/3PS_tkk5297_cluster.csv"
...
# Some Ports Show Up a Lot Together: Certain port numbers, like 17128, appear in almost every combination with others like 17140, 17132, and 17138. This makes it look like these ports have a strong connection or might be part of the same type of activity.
# 
# Tiny Changes, Same Frequency: If you switch one port in the set (like changing 17132 to 17138), the frequency barely changes. This could mean that even though there are small changes, the overall network activity is really similar.
# 
# Less Common Ports Lower the Count: When ports like 17142 join the set, the frequency drops more than with the main ones. This might mean that some ports don’t get used together as much or aren't as popular for whatever’s happening here.
